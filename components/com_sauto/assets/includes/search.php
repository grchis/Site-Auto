...
<div id="m_visitors" style="background-color:#F9F9F9">
	...
	<div class = "main-container">
		<form action="/android/index.php?option=com_sauto&amp;view=searching" method="post" name="search_form" id="search_form"			<fieldset style="margin-bottom: 15px;">
				<p>Firma: </p>
				<input type="text" name="firma" style="width: 100%;" />
			...
			<div id="submit" style="margin: 0px auto; padding-top: 10px; width:100%; text-align: center; height: 50px; background-color: #509EFF; color: white; font-size: 2.4em; padding-bottom: 10px;">
				Cauta Firme
			</div>
		</form>
	</div>
